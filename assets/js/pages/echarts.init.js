...
var app = {},
    ...
    myChart = echarts.init(chartDom),
    posList = ["left", "right", "top", "bottom", "inside", "insideTop", "insideLeft", "insideRight", "insideBottom", "insideTopLeft", "insideTopRight", "insideBottomLeft", "insideBottomRight"];
app.configParameters = {
    ...
    position: {
        options: posList.reduce(function (e, t) {
            return e[t] = t, e
        }, {})
    },
    distance: {
...
var option, chartHeatmapColors = getChartColorsArray("chart-heatmap"),
    chartDom = document.getElementById("chart-heatmap"),
    myChart = echarts.init(chartDom);

function getVirtulData(e) {
    e = e || "2017";
    for (var t = +echarts.number.parseDate(e + "-01-01"), a = +echarts.number.parseDate(e + "-12-31"), o = [], r = t; r <= a; r += 864e5) o.push([echarts.format.formatTime("yyyy-MM-dd", r), Math.floor(1e4 * Math.random())]);
    return o
}(option = {
    visualMap: {
        show: !1,
