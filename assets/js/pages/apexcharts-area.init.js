...
(timelinechart = new ApexCharts(document.querySelector("#area_chart_datetime"), timelinechart)).render();
...
(chart = new ApexCharts(document.querySelector("#area_chart_negative"), options)).render();
...
(chart = new ApexCharts(document.querySelector("#area_chart-months"), options)).render();
var areachartyearsColors = getChartColorsArray("area_chart-years"),
    ...
    chartYears = new ApexCharts(document.querySelector("#area_chart-years"), optionsYears);
chartYears.render();
var generateDayWiseTimeSeries = function (e, t, a) {
        for (var r = 0, o = []; r < t;) {
            var s = e,
    ...
    areachartstackedColors = getChartColorsArray("area_chart_stacked"),
    options = {
        series: [{
            name: "South",
...
(chart = new ApexCharts(document.querySelector("#area_chart_stacked"), options)).render();
...
(chart = new ApexCharts(document.querySelector("#area_chart_irregular"), options)).render();
options = {
    series: [{
        name: "Network",
        data: [{
    ...
    colors: areachartirregularColors = getChartColorsArray("area-missing-null-value")
};
